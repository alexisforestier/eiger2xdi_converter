...
Download the latest Release package for Windows ([https://github.com/alexisforestier/eiger2xdi_converter/releases/tag/v0.0](here)), unpack it, and run __eiger2xdi_converter.exe__.
